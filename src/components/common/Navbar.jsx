  ...
  return (
    <div className="flex h-14 items-center justify-center border-b-richblack-700 border-b-[1px]">
      <div className="flex  w-11/12 max-w-maxContent items-center justify-between ">
              ...
              {filteredLinks.length ? (
                filteredLinks.map((link, index) => (
                  <Link
                    ...
                    className="block p-2 text-black hover:bg-richblack-500 transition-all duration-200"
                  >
                    {link.name}
                  </Link>
                ))
        ...
        <Link to="/recommend">
              <button className="border border-richblack-500 bg-richblue-800 px-[12px] py-[8px] text-richblack-100 rounded-md text-xs text-white">
